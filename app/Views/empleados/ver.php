          ...
          <ul class="list-group text-center">
            ...
            <li class="list-group-item">
              <div class="row">
                ...
                <div class="col-md-6 text-left"><?php echo ucfirst($datos['domicilio']); ?></div>
              </div>
            </li>
            <li class="list-group-item">
              <div class="row">
            ...
            <li class="list-group-item">
              <a class="btn btn-default btn-block" href="<?php echo URL; ?>empleados"><i class="fa fa-2x fa-fw fa-mail-reply-all"></i></a>
            </li>                       
          </ul>
        </div>
        <div class="col-md-3"></div>     
